...
var et = gr.add("edittext"); 
    ...
    et.onChanging = function () {if (renew) collectSettings (gr.parent.parent)}
...
var etReplace = gr.add("edittext"); 
    ...
    dl.onChange = function () {if (renew) collectSettings (gr.parent.parent)}
    etFind.onChanging = function () {if (renew) collectSettings (gr.parent.parent)}
    etReplace.onChanging = function () {if (renew) collectSettings (gr.parent.parent)}
