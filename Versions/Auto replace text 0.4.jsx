...
function addWord (parent, s)
{
    ...
    var ch = gr.add("checkbox"); 
        ...
        sl.onChange = function () {if (renew) collectSettings (gr.parent.parent)}
...
var stToValue = gr.add("statictext"); 
    ...
    slFrom.onChange = function () {if (renew) collectSettings (gr.parent.parent)}
    slTo.onChange = function () {if (renew) collectSettings (gr.parent.parent)}
